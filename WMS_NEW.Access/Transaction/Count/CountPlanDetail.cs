...
{
    public class CountPlanDetail : AGridObjectSourceQuery
    {
        ...
        public override IQueryable<dynamic> InitialQueryView()
        {
            ...
            var result = from rows in this._Model.v_wms_count_plan_detail
    ...
    public class CountPlanReconcil : AGridObjectSourceQuery
    {
        public WMSEntities _Model { get; set; }

        public CountPlanReconcil()
        {
            this._Model = new WMSEntities();
        ...
        public override IQueryable<dynamic> InitialQueryView()
        {
            ...
            var result = from rows in this._Model.v_wms_count_reconcile
                         where rows.count_master_id == _count_master_id
                         select new
                         {
                             KeyId = "",
    ...
    //public class CountDetailAndReconcil : AGridObjectSourceQuery
    //{
    //    public WMSEntities _Model { get; set; }
    ...
    //        var result = from rows in this._Model.v_wms_count_reconcile_merge
