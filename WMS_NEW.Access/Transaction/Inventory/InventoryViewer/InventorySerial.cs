...
{
    public class InventorySerial : AGridObjectSourceQuery, IDisposable
    {
        ...
        public static InventorySerial Instance
        {
            get
            {
                using (InventorySerial _Instance = new InventorySerial())
                {
                    return _Instance;
                }
            }
        ...
        public override IQueryable<dynamic> InitialQueryView()
        {
            ...
            var result = from rows in this._Model.v_wms_inventory_data_by_serial
                         ...
                         && !string.IsNullOrEmpty(rows.serial_number)
                         ...
                         select new
                         {
                             ...
                             aging = SqlFunctions.DateDiff("dd", rows.receive_date, DateTime.Now),
