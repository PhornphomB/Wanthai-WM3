...
{
    public class InventoryItemSummary : AGridObjectSourceQuery,IDisposable
    {
        ...
        public static InventoryItemSummary Instance
        {
            get
            {
                using (InventoryItemSummary _Instance = new InventoryItemSummary())
                {
                    return _Instance;
                }
            }
