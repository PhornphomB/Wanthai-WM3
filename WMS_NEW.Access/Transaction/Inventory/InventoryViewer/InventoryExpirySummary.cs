...
{
    public class InventoryExpirySummary : AGridObjectSourceQuery, IDisposable
    {
        public WMSEntities _Model { get; set; }

        public InventoryExpirySummary()
        {
        ...
        public static InventoryExpirySummary Instance
        {
            get
            {
                using (InventoryExpirySummary _Instance = new InventoryExpirySummary())
                {
                    return _Instance;
                }
            }
        ...
        public override IQueryable<dynamic> InitialQueryView()
        {
            ...
            var result = from rows in qry
                         ...
                         by new
                         {
                             ...
                             rows.item_number,
                             rows.description,
                             expiry_date = DbFunctions.TruncateTime(rows.expiry_date),
                             rows.inv_status,
                             rows.uom
                         } into grp
                         select new
