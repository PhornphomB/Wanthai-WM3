<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucShipNotPODetail.ascx.cs" Inherits="WMS_NEW.Administrator.AscxControls.InterfaceMonitor.ucShipNotPODetail" %>


<ucControls:GridExt ID="gridDetail" runat="server"
    SourceAssemblyName="WMS_NEW.Access" SourceClassName="WMS_NEW.Access.Administrator.InterfaceMonitor.ShipNotPODetail" KeyField="KeyID" KeyType="String"
    ...
    <CustomColumnTemplate>
        ...
        <ucControls:GridColumnExt ID="GridColumnExt9" runat="server" HeaderText="Location" DataField="location" AllowSort="true" ResourceGroup="DisplayGenernal" ResourceName="location" />
        <ucControls:GridColumnExt ID="GridColumnExt3" runat="server" HeaderText="Lot Number" DataField="lot_number" AllowSort="true" ResourceGroup="DisplayGenernal" ResourceName="lot_number" />
        <ucControls:GridColumnExt ID="GridColumnExt4" runat="server" HeaderText="Allocate Qty" DataField="allocate_qty" AllowSort="true" ResourceGroup="DisplayGenernal" ResourceName="allocate_qty" />
        <ucControls:GridColumnExt ID="GridColumnExt17" runat="server" HeaderText="Delivery Qty" DataField="delivery_qty" AllowSort="true" ResourceGroup="DisplayGenernal" ResourceName="delivery_qty" />
        <ucControls:GridColumnExt ID="GridColumnExt5" runat="server" HeaderText="User ID" DataField="user_id" AllowSort="true" ResourceGroup="DisplayGenernal" ResourceName="user_id" />
