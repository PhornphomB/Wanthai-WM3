<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="UserWarehouse.aspx.cs" Inherits="WMS_NEW.MasterData.Mapping.UserWarehouse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ucControls:GridExt ID="GridExt1" runat="server"
        SourceAssemblyName="WMS_NEW.Access" SourceClassName="WMS_NEW.Access.MasterData.Mapping.UserWarehouse" KeyField="KeyId" KeyType="String" KeyFieldSelect="is_active"
        ColumnFreezeLength="0" GridSortDefault="wh_id" GridAllowRowEdit="false" GridAllowRowDelete="false"
        ...
        <CustomColumnTemplate>
            ...
            <ucControls:GridColumnExt runat="server" ResourceGroup="warehouse" ResourceName="wh_id" DataField="wh_id" AllowFilter="false" AllowSort="true" ShowFilterNow="false"  />
