<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="CountPlan.aspx.cs" Inherits="WMS_NEW.Transaction.Count.CountPlan" %>
                ...
                <ContentTemplate>
                    <div class="card card-accent-success">
                        <div class="card-header">
                            ...
                            <ucControls:LabelExt ID="lblDummy1" runat="server" DefaultText="Create Count Plan" CssClass="text-bold" ResourceGroup="count_plan_master" ResourceName="panel_count_plan" />
                        </div>
                        <div class="card-block row">
                            ...
                            <ucControls:InputDropDown ID="ddlOwner" runat="server" IsPrimary="true" LabelText="Owner" ResourceGroup="owner" ResourceName="Code" BaseContentCss="col-sm-12 col-md-12 col-lg-12" />
                            ...
                            <div class="row col-sm-12 col-md-12 col-lg-12 align-content-center ml-0 mt-2">
                                <ucControls:ButtonExt ID="btSave" runat="server" Text="Create Plan" CssClass="btn btn-block btn-success"
                                    OnClientClick="if (!confirm('Do you want to create plan ?')) return false;" OnClick="btSave_Click" ResourceGroup="count_plan_master" ResourceName="create_plan" />
                            </div>
                        </div>
                    </div>
                </ContentTemplate>
            ...
            <asp:UpdatePanel ID="updateCycleCount" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true" class="col-sm-8">
                <ContentTemplate>
                    <div class="card card-accent-info">
                        <div class="card-header">
                            <ucControls:LabelExt ID="LabelExt2" runat="server" DefaultText="Items Plan for Cycle Count" CssClass="text-bold" ResourceGroup="count_plan_master" ResourceName="panel_item_count_plan" />
                        </div>
                        <div class="card-block row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <ucControls:InputTextDate ID="txtMFGDate" runat="server" TextMode="Date" DataFieldValue="mfg_date" LabelText="MFG Date" Filterable="true" ResourceGroup="count_plan_master" ResourceName="mfg_date" BaseContentCss="col-sm-12 col-md-12 col-lg-12" />
                                <div class="row col-sm-12 col-md-12 col-lg-12 align-content-end ml-0 mt-3 mb-3">
                                    ...
                                    <ucControls:ButtonExt ID="btnRemoveItemAll" runat="server" Text="Clear All Items" CssClass="btn btn-sm btn-danger col-sm-5 col-md-4 col-lg-3" CausesValidation="false" OnClick="btnRemoveItemAll_Click" OnClientClick="if (!confirm('Confirm Clear All ?')) return false;"  ResourceGroup="count_plan_master" ResourceName="ClearItem" />
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <ucControls:GridExt ID="gridCyclePlan" runat="server"
                                    SourceAssemblyName="WMS_NEW.Access" SourceClassName="WMS_NEW.Access.Transaction.Count.CycleCountTemp" KeyField="KeyId" KeyType="Guid"
                                    ...
                                    <CustomColumnTemplate>
                                        ...
                                        <ucControls:GridColumnExt ID="GridColumnExt6" runat="server" HeaderText="Lot No." DataField="lot" AllowSort="true" ResourceGroup="inventory" ResourceName="Lot" />
