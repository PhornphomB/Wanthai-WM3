<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InventoryChangeExpDate.aspx.cs" Inherits="WMS_NEW.Transaction.Inventory.InventoryChangeExpDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        ...
        <CustomCommandTemplate>
            <ucControls:ButtonExt ID="btnChangeExpDate" runat="server" CssClass="btn btn-sm btn-success" Text="Change Expiry Date" OnClick="btnChangeExpDate_Click" ResourceGroup="inventory" ResourceName="btn_change_expiry_date" />
        </CustomCommandTemplate>
        <CustomSearchTemplate>
            <ucControls:InputHidden ID="hid_control_exp_date" runat="server" DataFieldValue="_control_exp_date" />
        </CustomSearchTemplate>
