<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InventoryChangeSerialLocation.aspx.cs" Inherits="WMS_NEW.Transaction.Inventory.InventoryChangeSerialLocation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ucControls:PanelPopup ID="popupChange" runat="server" HeaderText="Change Location Serial">
        <DataTemplate>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group" style="margin-left: 0px">
                        ...
                        <span class="input-group-prepend">
                            <ucControls:InputTextBox runat="server" ResourceGroup="inventory" ResourceName="parent_lpn" ID="txtParentLPN" Readonly="true" />
                        </span>
                    </div>
                    <div class="input-group" style="margin-left: 0px">
                        <ucControls:InputCheckBox runat="server" ResourceGroup="general" ResourceName="stay" ID="chkLPN" AutoPostBack="true" />
                        <span class="input-group-prepend">
                            <ucControls:InputTextBox runat="server" ResourceGroup="inventory" ResourceName="lpn" ID="txtLPN" Readonly="true" />
                        </span>
                    </div>
        ...
        <CommandTemplate>
            <ucControls:ButtonExt ID="btnConfirmChange" runat="server" Text="Confirm" CssClass="btn btn-info"  ResourceGroup="general" ResourceName="btn_confirm" OnClick="btnConfirmChange_Click" />
        </CommandTemplate>
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        ...
        <CustomCommandTemplate>
            <ucControls:ButtonExt ID="btnChangeLocation" runat="server" Text="Change Location" CssClass="btn btn-info btn-sm" OnClick="btnChangeLocation_Click"  ResourceGroup="inventory" ResourceName="btn_change_location" />
