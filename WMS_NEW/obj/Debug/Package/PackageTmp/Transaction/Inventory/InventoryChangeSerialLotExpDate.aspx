<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InventoryChangeSerialLotExpDate.aspx.cs" Inherits="WMS_NEW.Transaction.Inventory.InventoryChangeSerialLotExpDate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ucControls:PanelPopup ID="popupChange" runat="server" HeaderText="Change Expiry Date">
        <DataTemplate>
            <div class="form-group row">
                <div class="col-sm-6">
                    <ucControls:InputTextBox runat="server" ResourceGroup="inventory" ResourceName="lot_number" ID="txtLot" IsPrimary="true" />
                    <ucControls:InputTextDate runat="server" ResourceGroup="inventory" ResourceName="mfg_date" ID="txtMfgDate" TextMode="Date" IsPrimary="true" />
                    <ucControls:InputTextDate runat="server" ResourceGroup="inventory" ResourceName="expiry_date" ID="txtExpDate" TextMode="Date" IsPrimary="true" />
                </div>
                <div class="col-sm-6">
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        ...
        <CustomCommandTemplate>
            <ucControls:ButtonExt ID="btnChangeExpDate" runat="server" CssClass="btn btn-sm btn-success" Text="Change Lot Expiry Date" OnClick="btnChangeExpDate_Click" ResourceGroup="inventory" ResourceName="btn_change_lot_expiry_date" />
        </CustomCommandTemplate>
        <CustomSearchTemplate>
            <ucControls:InputHidden ID="hid_control_lot_exp_date" runat="server" DataFieldValue="_control_lot_exp" />
        </CustomSearchTemplate>
