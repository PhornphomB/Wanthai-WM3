<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WMS_NEW.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="grid">
        ...
        <asp:UpdatePanel ID="updateContent" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true" class="row mt-3">
            <ContentTemplate>
                <asp:UpdatePanel ID="updateFilter" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true" class="col-sm-3">
                    <ContentTemplate>
                        <div class="card">
                            <div class="card-header">
                                <strong>Filter</strong>
                            </div>
                            <div class="card-block" style="border-bottom: solid 1px lightgray">
                            ...
                            <div class="card-block" style="overflow: scroll; height: 500px">
                                ...
                                <ucControls:InputDropDown ID="ddlWareHouse" runat="server" Filterable="true" DataFieldValue="wh_master_id" DisplayDefault="-- All --" LabelText="Warehouse ID" ResourceGroup="warehouse" ResourceName="wh_id" />
                                <ucControls:InputDropDown ID="ddlOwner" runat="server" Filterable="true" DisplayDefault="-- All --" DataFieldValue="owner_id" AutoPostBack="true" LabelText="Owner" ResourceGroup="owner" ResourceName="owner_code" />
                                <ucControls:InputTextBox ID="txtZone" runat="server" Filterable="true" DataFieldValue="zone" LabelText="Zone" ResourceGroup="zone" ResourceName="zone" />
                                <ucControls:InputTextBox ID="txtLocation" runat="server" Filterable="true" DataFieldValue="location" LabelText="Location" ResourceGroup="location" ResourceName="location" />
                                <ucControls:InputDropDownHD ID="ddlItemCategory" runat="server" Filterable="true" DisplayDefault="-- All --" DataFieldValue="category_id" LabelText="Item Category" ResourceGroup="category" ResourceName="category" />
                                <ucControls:InputDropDownHD ID="ddlItem" runat="server" Filterable="true" DataFieldValue="item_number" ComboType="String" LabelText="Item" ResourceGroup="item" ResourceName="item_number" DisplayDefault="-- All --" />
                                <ucControls:InputTextBox ID="txtDescription" runat="server" Filterable="true" DataFieldValue="description" LabelText="Description" ResourceGroup="item" ResourceName="description" />
                                <ucControls:InputTextBox ID="txtLPN" runat="server" Filterable="true" DataFieldValue="lpn" LabelText="LPN" ResourceGroup="inventory" ResourceName="lpn" />
                                <ucControls:InputTextBox ID="txtBatch" runat="server" Filterable="true" DataFieldValue="lot_number" LabelText="Batch" ResourceGroup="inventory" ResourceName="lot_number" />
                                <ucControls:InputTextDate ID="dtpExpiryDate" runat="server" Filterable="true" TextMode="Date" DataFieldValue="expiry_date" LabelText="Expiry Date" ResourceGroup="inventory" ResourceName="expiry_date" />
                                <ucControls:InputTextBox ID="txtSerial" runat="server" Filterable="true" DataFieldValue="serial_number" LabelText="Serial Number" ResourceGroup="inventory" ResourceName="serial_number" />
                                <ucControls:InputTextDate ID="dtpReceiveDate" runat="server" Filterable="true" TextMode="Date" DataFieldValue="receive_date" LabelText="Receive Date" ResourceGroup="receipt_detail" ResourceName="receive_date" />
                                <ucControls:InputDropDown ID="ddlInventoryStatus" runat="server" Filterable="true" ComboType="String" DisplayDefault="-- All --" DataFieldValue="inv_status" LabelText="Inventory Status" ResourceGroup="inventory" ResourceName="inv_status" />
                                <ucControls:InputTextBox ID="txtDGCode" runat="server" Filterable="true" DataFieldValue="dg_code" LabelText="DG Code" ResourceGroup="item" ResourceName="dg_code" VisibleExt="false" />
                                <ucControls:InputTextNumber ID="txtQty" runat="server" Filterable="true" DataFieldValue="quantity" LabelText="Qty" ResourceGroup="inventory" ResourceName="quantity" />
                                <ucControls:InputTextNumber ID="txtQtyAllowcate" runat="server" Filterable="true" DataFieldValue="quantity_allocated" LabelText="Qty Allowcate" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                <ucControls:InputTextBox ID="txtItemGrade" runat="server" Filterable="true" DataFieldValue="grade" LabelText="Grade" ResourceGroup="item" ResourceName="grade" VisibleExt="false" />
                ...
                <asp:UpdatePanel ID="updateView" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true" class="col-sm-9">
                    <ContentTemplate>
                        <div class="card">
                            <div class="card-header">
                                <strong>View</strong>
                                        ...
                                        <ucControls:PanelControlTab ID="pnItem" runat="server" PanelName="By Item" ResourceGroup="inventory" ResourceName="TabByItem">
                                            ...
                                            <ucControls:GridExt ID="GridExtItem" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt70" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt95" runat="server" DataField="isBeforeExp" Visible="false" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnAging" runat="server" PanelName="By Aging" ResourceGroup="inventory" ResourceName="TabByaging">
                                            <ucControls:GridExt ID="GridExtAging" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt31" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnSerial" runat="server" PanelName="By Serial" ResourceGroup="inventory" ResourceName="TabBySerial">
                                            <ucControls:GridExt ID="GridExtSerial" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt68" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnItemSummary" runat="server" PanelName="Item Summary" ResourceGroup="inventory" ResourceName="TabByItemSum">
                                            <ucControls:GridExt ID="GridExtItemSummary" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt2" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnBatchSummary" runat="server" PanelName="Batch Summary" ResourceGroup="inventory" ResourceName="TabByBatchSum">
                                            <ucControls:GridExt ID="GridExtBatchSummary" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt21" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnExpirySummary" runat="server" PanelName="Expiry Date Summary" ResourceGroup="inventory" ResourceName="TabByExpSum">
                                            <ucControls:GridExt ID="GridExtExpirySummary" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt46" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnAttribute" runat="server" PanelName="Inventory Attribute" ResourceGroup="inventory" ResourceName="TabAttribute">
                                            <ucControls:GridExt ID="GridInventoryAttribute" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt115" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
                                        ...
                                        <ucControls:PanelControlTab ID="pnItemExpiry" runat="server" PanelName="Item Expire" ResourceGroup="inventory" ResourceName="TabByItemExpire">
                                            <ucControls:GridExt ID="gridItemExpire" runat="server"
                                                ...
                                                <CustomColumnTemplate>
                                                    ...
                                                    <ucControls:GridColumnExt ID="GridColumnExt138" runat="server" HeaderText="Quantity Allowcate" DataField="quantity_allocated" FormatType="Number" AllowSort="true" ResourceGroup="inventory" ResourceName="quantity_allocated" />
