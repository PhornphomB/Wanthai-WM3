<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InventoryChangeLot.aspx.cs" Inherits="WMS_NEW.Transaction.Inventory.InventoryChangeLot" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ucControls:PanelPopup ID="popupChange" runat="server" HeaderText="Change Lot">
        <DataTemplate>
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        ...
        <CustomCommandTemplate>
            <ucControls:ButtonExt ID="btnChangeLot" runat="server" CssClass="btn btn-sm btn-success" Text="Change Lot" OnClick="btnChangeLot_Click" ResourceGroup="inventory" ResourceName="btn_change_lot" />
        </CustomCommandTemplate>
        <CustomSearchTemplate>
            <ucControls:InputHidden ID="hid_control_lot" runat="server" DataFieldValue="_control_lot" />
        </CustomSearchTemplate>
