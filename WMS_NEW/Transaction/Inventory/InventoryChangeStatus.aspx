<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InventoryChangeStatus.aspx.cs" Inherits="WMS_NEW.Transaction.Inventory.InventoryChangeStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <DataTemplate>
            <div class="form-group row">
                <div class="col-sm-12">
                    ...
                    <ucControls:InputTextNumber runat="server" ResourceGroup="inventory" ResourceName="quantity" ID="txtQty" IsPrimary="true" Enabled="false" />
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        ...
        GridAllowRowEdit="false" GridAllowRowDelete="false" AutoSize="true" GridAllowSelectBox="true" DisableExport="true" NewVisible="false" GridAllowShowSelectBoxAll="true" GridSortDefault="create_date">
...
<%--            <ucControls:GridColumnExt runat="server" ResourceGroup="inventory" ResourceName="serial_number" ID="GridColumnExt16" DataField="serial_number" AllowSort="true" AllowFilter="true" ShowFilterNow="true" />--%>
            ...
            <ucControls:GridColumnExt runat="server" ResourceGroup="inventory" ResourceName="attribute1" ID="GridColumnExt3" DataField="attribute1" AllowSort="true" AllowFilter="true" ShowFilterNow="true" />
