<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="InboundPrintLabel.aspx.cs" Inherits="WMS_NEW.Transaction.Inbound.InboundPrintLabel" %>

<%@ Register Src="~/Transaction/Inbound/AscxControl/ucInboundPrintLabelDetail.ascx" TagPrefix="ucControls" TagName="ucInboundPrintLabelDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ucControls:PanelPopupEntity ID="popupEntity1" runat="server" VisibleSave="false" >
        <ControlTemplate>
            ...
            <ucControls:PanelTab ID="PanelTab1" runat="server">
                <ControlTemplate>
                    <ucControls:PanelControlTab ID="PanelControlTab6" runat="server" PanelName="Print Label Detail" ResourceGroup="print_label" ResourceName="tab_print_label_detail">
                        <ucControls:ucInboundPrintLabelDetail runat="server" ID="ucInboundPrintLabelDetail" />
    ...
    <ucControls:GridExt ID="GridExt1" runat="server"
        SourceAssemblyName="WMS_NEW.Access" SourceClassName="WMS_NEW.Access.Transaction.Inbound.InboundPrintLabel" KeyField="KeyId" KeyType="Guid" VisibleExportTemplate="true"
        ...
        <CustomSearchTemplate>
            ...
            <%--<ucControls:InputTextBox ID="txtRefInboundOrder" runat="server" ResourceGroup="inbound_master" ResourceName="ref_inbound_order_number" DataFieldValue="_ref_inbound_order_number" DefaultFilter="Contains" FixFilter="true" />--%>
        ...
        <CustomColumnTemplate>
            ...
            <%--<ucControls:GridColumnExt runat="server" ResourceGroup="owner" ResourceName="owner_code" ID="iColOwner" DataField="owner_code" DataFieldFilter="owner_id" FilterFormatType="Guid" AllowFilter="true" AllowSort="false" ShowFilterNow="false" UseFilterDropDown="true" DropDownDisplayDefault="--All--" />--%>
            ...
            <%--<ucControls:GridColumnExt runat="server" ResourceGroup="item" ResourceName="item_number" DataField="item_number_ex" Width="400" AllowSort="true" Visible="false"/>--%>
            ...
            <%--<ucControls:GridColumnExt runat="server" ResourceGroup="inbound_master" ResourceName="expected_delivery_date" DataField="expected_delivery_date" FormatType="Date" AllowFilter="true" AllowSort="true" ShowFilterNow="false" />--%>
            ...
            <%--<ucControls:GridColumnExt runat="server" ResourceGroup="supplier" ResourceName="supplier_name" DataField="supplier_name" AllowFilter="true" AllowSort="true" ShowFilterNow="false" FormatType="Text" FilterFormatType="Text" />--%>
