<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ZoneLocation.aspx.cs" Inherits="WMS_NEW.MasterData.Mapping.ZoneLocation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ucControls:GridExt ID="GridExt1" runat="server"
        SourceAssemblyName="WMS_NEW.Access" SourceClassName="WMS_NEW.Access.MasterData.Mapping.ZoneLocation" KeyField="KeyId" KeyType="String" KeyFieldSelect="is_active"
        ColumnFreezeLength="0" GridSortDefault="location" GridAllowRowEdit="false" GridAllowRowDelete="false"
        AutoGenerateColumn="true" ShowAllSort="true" ShowAllFilter="false" GridAllowSelectBox="true" DisableFirstSearch="true" AutoGenColumnFields_Exclude="is_active,location_id" AutoGenColumnFields_SEARCH="location">
        ...
        <CustomColumnTemplate>
            ...
            <ucControls:GridColumnExt runat="server" ResourceGroup="location" ResourceName="location" DataField="location" AllowFilter="true" AllowSort="true" ShowFilterNow="false" />
