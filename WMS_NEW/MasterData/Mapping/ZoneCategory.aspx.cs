...
{
    public partial class ZoneCategory : PageCustom
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                iColZone.DropDownQueryProperty = delegate () { return new Access.MasterData.Zone().GetQuery_Warehouse(this.wh_master_id); };
        ...
        protected void btMapping_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (var _acc = new Access.MasterData.Mapping.ZoneCategory())
                {
