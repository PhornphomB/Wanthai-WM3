...
{
    public partial class ucInboundDetail : UControlCustom
    {
        ...
        {
            using (var acc = new Access.Administrator.InterfaceMonitor.Inbound())
            {
                PlugEventResult(acc);
        ...
        {
            hidInboundID.SetValue(host_record_id);
            gridInboundDetail.Search();
